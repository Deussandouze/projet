...
{
    /*!
    * \brief Fonction de copie d'un tableau. La copie s'effectue en decalant chaque caractères d'une place sur la droite, utilise dans la fonction invTrad.
    */
...
void ajouter()
{
    ...
    */
    ...
    else printf("Impossible d'accès");
